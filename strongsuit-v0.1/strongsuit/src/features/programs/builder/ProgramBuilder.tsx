...
import { Button, Dialog, Select, Field, toast } from '@/design'
...
export default function ProgramBuilder() {
  ...
  return (
    <div className="flex flex-col h-full bg-surface2">
      {/* Builder Header */}
      <div className="flex-none px-4 py-3 border-b border-line bg-surface flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="sm" onClick={() => navigate('/programs')} className="-ml-2">
            <ArrowLeft size={16} />
          </Button>
          <input 
            type="text" 
            ...
            className="text-lg font-bold text-ink bg-transparent border-none p-0 focus:ring-0 focus:outline-none placeholder:text-muted"
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Pane (Outline) */}
        <div className="w-64 flex-none border-r border-line bg-surface">
          <BuilderOutline 
            draft={draft}
